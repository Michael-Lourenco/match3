...
public class ShapesManager : MonoBehaviour
{
   ...
   private int score;
    ...
    private void InitializeUI(){
        ...
        currentLevelIndex =0;
        timer=fixedTimer;
        sliderMainTimer.value =fixedTimer;
       
        scoreText.text=score.ToString()+"/"+levels[currentLevelIndex].scoreGoalValue.ToString();
        levelText.text = levels[currentLevelIndex].levelName;
        gameOn=true;
    }
    /// <summary>
    /// Initialize shapes
    ...
    {
        score += amount;
        if(score>= levels[currentLevelIndex].scoreGoalValue){
    ...
    {
        resultText.text = levels[currentLevelIndex].levelName +" / "+ score.ToString();
    }
...
public class Level{
    ...
    public Level(int newScoreGoalValue, string newLevelName){
        scoreGoalValue = newScoreGoalValue;
